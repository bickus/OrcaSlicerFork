...
- The toolhead marker shows both requested and actual speeds, and the existing range caps automatically adopt the new colors because they read from the updated path payloads.
