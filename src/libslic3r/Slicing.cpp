	...
	const t_layer_config_ranges &layer_config_ranges)
{
    ...
    if (layer_height_profile.empty())
        BOOST_LOG_TRIVIAL(warning) << "[PHM] layer_height_profile_from_ranges() returning empty profile";
...
{
    if (layer_height_profile.empty()) {
        BOOST_LOG_TRIVIAL(error) << "[PHM] generate_object_layers: layer_height_profile is empty!";
        return {};
    }
    ...
    if (out.empty())
        BOOST_LOG_TRIVIAL(warning) << "[PHM] generate_object_layers: returning empty layer list!";
