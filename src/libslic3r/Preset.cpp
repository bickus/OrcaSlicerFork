...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridge_speed", "internal_bridge_speed", "extra_bridge_speed", "gap_infill_speed", "travel_speed", "travel_speed_z", "initial_layer_speed",
    ...
    "support_top_z_distance", "support_on_build_plate_only","support_critical_regions_only", "bridge_no_support", "thick_bridges", "thick_internal_bridges","dont_filter_internal_bridges","enable_extra_bridge_layer", "bridge_infill_at_end", "max_bridge_length", "print_sequence", "print_order", "support_remove_small_overhang",
    ...
    "outer_wall_line_width", "sparse_infill_line_width", "internal_solid_infill_line_width", "bridge_infill_line_width", "internal_bridge_infill_line_width", "extra_bridge_infill_line_width",
    "skin_infill_line_width","skeleton_infill_line_width",
    "top_surface_line_width", "support_line_width", "infill_wall_overlap","top_bottom_infill_wall_overlap", "bridge_infill_wall_overlap", "extra_bridge_infill_wall_overlap", "bridge_flow", "internal_bridge_flow", "extra_bridge_flow",
    ...
    "flush_into_infill", "flush_into_objects", "flush_into_support",
     ...
     "small_perimeter_speed", "small_perimeter_threshold","bridge_angle","internal_bridge_angle", "filter_out_gap_fill", "travel_acceleration","bridge_travel_acceleration","inner_wall_acceleration", "min_width_top_surface",
     "default_jerk", "outer_wall_jerk", "inner_wall_jerk", "infill_jerk", "bridge_jerk", "internal_bridge_jerk", "extra_bridge_jerk", "top_surface_jerk", "initial_layer_jerk","travel_jerk","bridge_travel_jerk","default_junction_deviation",
     ...
     "bridge_density","internal_bridge_density", "extra_bridge_density", "precise_outer_wall", "bridge_acceleration", "internal_bridge_acceleration", "extra_bridge_acceleration",
...
static std::vector<std::string> s_Preset_machine_limits_options {
    ...
    // Klipper time estimation
    "klipper_minimum_cruise_ratio", "klipper_instant_corner_velocity",
};
