...
std::map<std::string, std::vector<SimpleSettingData>>  SettingsFactory::PART_CATEGORY_SETTINGS=
{
    { L("Quality"), {{"ironing_type", "",8},{"ironing_flow", "",9},{"ironing_spacing", "",10},{"ironing_inset", "", 11},{"bridge_flow", "",11},{"make_overhang_printable", "",11},{"bridge_density", "", 1},
                    {"wall_generator", "",12},{"wall_transition_length", "",13},{"wall_transition_filter_deviation", "",14},{"wall_transition_angle", "",15},
                    {"wall_distribution_count", "",16},{"min_feature_size", "",17},{"min_bead_width", "",18},{"initial_layer_min_bead_width", "",19},{"min_length_factor", "",20}
                    }},
